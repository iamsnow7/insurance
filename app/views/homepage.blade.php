...
<html lang="en" dir="ltr" ng-app="module">
  ...
  <body>
    ...
    <div class="wrapper">
      <ul>
        ...
        <li class="navigation" style="width:90px;">
          <i class="fa fa-key"></i>
          <a class="nav_link" href="{{URL::to('authenticate')}}">Login</a>
        </li>
        <li class="navigation" style="width:100px;">
          <i class="fa fa-user"></i>
          <a class="nav_link" href="{{URL::to('authenticate/')}}">Register</a>
        </li>
    ...
    <div class="banner" style="height:500px;width:100%;background-image: url('{{asset('images/Impact-Investing-Jars.jpg')}}'); background-repeat:no-repeat;background-size:cover; padding-bottom:120px;">
...
<!--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js')}}"></script>-->
    <script type="text/javascript" src="{{asset('js_home/jquery.min.js')}}"></script>
  
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="{{asset('js/index.js')}}"></script>
  <script src="{{asset('js_home/textition.js')}}"></script>
  <script type="text/javascript" src="{{asset('js_home/jquery.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js_home/angular.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js_home/angular-route.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js_home/menu.js')}}"></script>
  <script type="text/javascript" src="{{asset('js_home/authCat.js')}}"></script>
    <script type="text/javascript" src="{{asset('js_home/clicktoshow.js')}}"></script>
